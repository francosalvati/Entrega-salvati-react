    ...
    return (
        <nav className='text-bg-light p-2 pt-4'>
            ...
            <ul className="nav d-flex flex-column col-12 m-0 mb-2 p-0 ">
                <li className='text-muted fs-6 fw-bold border-bottom my-2 p-2'> Filtrar </li>
                ...
                <li className='text-muted fs-6 fw-bold border-bottom my-2 p-2'> Categorias </li>
                ...
                <li className='text-muted fs-6 fw-bold border-bottom my-2 p-2'> Compras </li>
                <span className='nav__shop' >
                    <li><Link to={`/cart`}className="nav-link px-2">Carrito</Link></li>
